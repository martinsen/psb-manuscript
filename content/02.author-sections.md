...
I'm a graduate student in the Boussard Lab at Stanford, working on secondary analyses of EHR data. 
We are interested in developing machine learning models for electronic phenotyping (i.e. building research cohorts) and for predicting patient outcomes, mainly with an oncology focus.

We recently published a paper on patient reported outcomes in prostate cancer showing significant demographic differences in patient-reported physical and mental health [@doi:10.1002/cncr.31895].

I'm soon finishing my time in the lab and returning to clinical medicine.
